...
const githubHistoricalSchoolSignals: GithubHistoricalSchoolSignal[] = [
  ...
  },
  {
    ...
    sourceSchoolId: "47",
    outcomeRate: "98.65%",
    postgraduateRate: "53.10%",
    abroadRate: "20.52%",
    companies: ["中国航发", "航空工业", "部队", "工信部直属单位", "兵器工业", "航天科技", "航天科工", "电子科技", "中国商飞", "工信部属各高校"],
  },
  {
    id: "bupt",
    name: "北京邮电大学",
  ...
  },
  {
    ...
    sourceSchoolId: "73",
    outcomeRate: "98.70%",
    postgraduateRate: "33.69%",
    abroadRate: "23.08%",
    companies: ["中国建筑股份有限公司", "上海汽车集团股份有限公司", "上海建工集团", "华为投资控股有限公司", "上海学而思教育培训有限公司", "上海市同济医院", "隧道股份", "同济大学建筑设计研究院（集团）有限公司", "同济大学", "中国银行", "上海市第十人民医院", "中国铁道建筑总公司", "SAP公司", "招商银行", "上海市东方医院"],
  },
  {
    id: "sustech",
    name: "南方科技大学",
