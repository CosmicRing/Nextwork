...
export const externalDataSources: ExternalDataSource[] = [
  ...
  {
    id: "jhcoco-bosszp-national-csv",
    name: "bosszp 全国热门城市 BOSS CSV 候选",
    repoUrl: "https://github.com/jhcoco/bosszp",
    license: "Unknown",
    status: "blocked-license",
    coverage: "仓库含 全国-热门城市岗位数据.csv，README 描述覆盖大数据、数据分析、数据挖掘、机器学习和人工智能相关岗位，CSV 字段约 10 个，文件约 38KB。",
    currentUse: "只登记为真实 BOSS CSV 候选和字段参考，聚合为 src/data/bossCandidateSignals.ts 的候选计数；不导入 CSV、不复制公司名、岗位名或 README 统计结论。",
    caution: "仓库未声明许可证，README 同时展示 Scrapy、Cookie 和反爬绕过配置；不能作为 MIT 开源前端事实库的数据输入。",
  },
  {
  ...
  {
    id: "maimaigptlink9-boss-career-ops",
    name: "boss-career-ops BOSS 求职流程评估架构",
    repoUrl: "https://github.com/maimaigptlink9/boss-career-ops",
    license: "MIT",
    status: "architecture-reference",
    coverage: "README 描述 BOSS 求职全流程 CLI、5 维评分、阈值动作、简历定制、聊天管理、Pipeline 和 Web 仪表盘；默认本地配置和缓存。",
    currentUse: "登记为本地 BOSS 授权导入后的 5 维评分、Pipeline 看板和候选岗位评估架构参考；不导入岗位数据、不复用自动投递或打招呼逻辑。",
    caution: "该源的价值在本地工作流和评估架构，不是可再发布数据源；本项目需要保留用户确认边界，不能自动执行平台交互。",
  },
  {
    id: "yuzhii-boozp-neo",
  ...
  {
    id: "my0sot1s-boss-crawler",
    name: "boss-crawler 全城岗位采集链路候选",
    repoUrl: "https://github.com/My0sot1s/boss-crawler",
    license: "MIT",
    status: "blocked-raw-import",
    coverage: "README 描述 Node.js + Selenium 采集所有记录城市的指定岗位，输出 JSON/CSV，并依赖用户登录和第三方验证码识别平台。",
    currentUse: "只登记为 BOSS 本地授权导入器的风险边界和输出字段参考，聚合为 src/data/bossCandidateSignals.ts 的候选计数；不复用采集代码或验证码链路。",
    caution: "该链路默认全城批量采集，README 明确可能触发风控；本项目不能实现或鼓励绕过登录、验证码、反爬或批量抓取。",
  },
  {
